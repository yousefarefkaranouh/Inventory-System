 ...
 * I tried to keep it simple and organized so it's not confusing.
 * Buttons are placed in the center and I added light colors to make it look nicer.
 */
 ...
 public class Main {
     ...
     public Main(InventoryManager store) {
         ...
         buttonPanel.setLayout(new GridLayout(5, 1, 0, 10)); // 5 buttons stacked vertically with spacing
         ...
         addBtn.addActionListener(e -> {
             try {
                 ...
                 JOptionPane.showMessageDialog(frame, "Invalid input (check what you typed)");
             }
         });
         ...
         deleteBtn.addActionListener(e -> {
             try {
                 ...
                 displayArea.setText("Delete operation finished.");
             } catch (Exception ex) {
